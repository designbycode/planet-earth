<headless-navigation class="fixed w-full z-[100] top-0 block text-gray-500 dark:bg-black/80 bg-white/90 border-b border-gray-300 dark:border-primary-500/50 dark:text-gray-100 shadow-md shadow-primary-500/20 backdrop-blur-md">
